...
import { DateRange, FlightTakeoff, Home, Search, Settings } from '@mui/icons-material'
    ...
    <List>
      {menuItems.map((item) => (
        <ListItem key={item.text} disablePadding>
          <ListItemButton component="a" href={item.path} selected={pathname === item.path} onClick={isMobile ? onClose : undefined}>
