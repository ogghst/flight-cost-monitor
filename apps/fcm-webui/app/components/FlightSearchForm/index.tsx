            ...
            render={({ field }) => (
              <FormControl fullWidth>
                ...
                <Select {...field} label="Travel Class">
                  <MenuItem value={TravelClass.ECONOMY}>Economy</MenuItem>
                  <MenuItem value={TravelClass.PREMIUM_ECONOMY}>
                    Premium Economy
                  </MenuItem>
                  <MenuItem value={TravelClass.BUSINESS}>Business</MenuItem>
                  <MenuItem value={TravelClass.FIRST}>First</MenuItem>
                </Select>
              </FormControl>
            )}
          />
